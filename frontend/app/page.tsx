      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <Link href="/student" className="h-full">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow cursor-pointer border-2 border-transparent hover:border-blue-500 h-full flex flex-col">
          ...
          <Link href="/admin" className="h-full">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow cursor-pointer border-2 border-transparent hover:border-purple-500 h-full flex flex-col">
              <div className="text-4xl mb-4">🏫</div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                University Portal
              </h2>
          ...
          <Link href="/employer" className="h-full">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow cursor-pointer border-2 border-transparent hover:border-green-500 h-full flex flex-col">
              <div className="text-4xl mb-4">🏢</div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                Employer Portal
              </h2>
